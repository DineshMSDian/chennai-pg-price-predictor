...
def train():
    ...
    # building model with best params (from grid search of XGboost)
    ...
    val_metrics   = evaluate("Val",   model, X_val_processed,   y_val)
...
if __name__ == "__main__":
    ...
    print("\nFinal val  R²  ", round(val_metrics["r2"], 4))
    print("Final test R²  ", round(test_metrics["r2"], 4))
    print("\nDone.")